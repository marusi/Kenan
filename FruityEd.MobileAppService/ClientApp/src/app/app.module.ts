...
@NgModule({
  declarations: [
    ...
    HeaderComponent, ArticleListComponent, AdminComponent,
    HomeComponent, ErrorComponent, NewsComponent,
    CounterComponent, AboutComponent, CarouselComponent,
    AcademicsComponent, SchoolsComponent, SignupComponent, SigninComponent,
